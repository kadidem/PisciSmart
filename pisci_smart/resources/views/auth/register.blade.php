                    ...
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3 form-group icon-input">
                                <i class="font-sm  text-grey-500 pe-0" style="margin-top: -10px"> <svg
                            ...
                            <nav class="nav mb-2">
                                <li class="nav-item"><a class="nav-link btn btn-info mx-1"
                                        onclick="toggle_email_and_phone_fields('email','Your Email Address')">Email</a>
                                </li>
                                <li class="nav-item"><a class="nav-link btn btn-info mx-1"
                                        onclick="toggle_email_and_phone_fields('tel','Your Phone Number')">Phone</a></li>
                            </nav>

                            <div class="form-group icon-input mb-3">
                                <i class="font-sm ti-email text-grey-500 pe-0"></i>
                                <input type="email" id="email_or_phone" name="email"
                                    class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600"
                                    placeholder="Your Email Address">
                                <script>
                                    function toggle_email_and_phone_fields(input_type, place_holder) {
                                        let element = document.querySelector("#email_or_phone");
                            ...
                            <div class="mb-3 form-group ">
                                <input type="file" id="profile" class="custom-file-input" name="profile">
                                <label for=""></label>
                            </div>
